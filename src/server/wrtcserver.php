...
$server = new \Wrench\Server('ws://hotbiz.admiral.co.jp.private:8484/', array(
    'allowed_origins'            => array('mysite.localhost'),
    'check_origin'               => true,
    'connection_manager_class'   => 'Wrench\ConnectionManager',
    'connection_manager_options' => array(
        'timeout_select'           => 200000, //0,
...
$server->registerApplication('webrtc', new \Wrench\Application\WebRTCApplication());
$server->run();
